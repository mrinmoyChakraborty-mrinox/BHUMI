...
export default function CropRecommendation({ language }: CropRecommendationProps) {
  ...
  const labels = {
    en: {
      ...
      sub: "Recommendations are generated by Google Gemini using soil nutrients, climate data and official agricultural datasets. No custom crop prediction ML model has been trained.",
    ...
    hi: {
      ...
      sub: "Google Gemini द्वारा मिट्टी के पोषक तत्वों, जलवायु डेटा और आधिकारिक कृषि डेटासेट का उपयोग करके सिफारिशें उत्पन्न की जाती हैं। कोई कस्टम फसल पूर्वानुमान ML मॉडल प्रशिक्षित नहीं किया गया है।",
    ...
    bn: {
      ...
      sub: "মাটির পুষ্টি উপাদান, জলবায়ু ডেটা এবং অফিসিয়াল কৃষি ডেটাসেট ব্যবহার করে Google Gemini দ্বারা সুপারিশ তৈরি করা হয়। কোনো কাস্টম ফসল পূর্বাভাস ML মডেল প্রশিক্ষিত হয়নি।",
    ...
    te: {
      title: "స్మార్ట్ పంట సూచన",
      sub: "Google Gemini నేల పోషకాలు, వాతావరణ డేటా మరియు అధికారిక వ్యవసాయ డేటాసెట్లను ఉపయోగించి సిఫార్సులను రూపొందిస్తుంది. ఎటువంటి కస్టమ్ పంట సూచన ML మోడల్ శిక్షణ పొందలేదు.",
      n: "నత్రజని (N) - ఆకుల పెరుగుదల",
      p: "భాస్వరం (P) - మూల అభివృద్ధి",
      k: "పొటాషియం (K) - వ్యాధి నిరోధకత",
      soil: "నేల వర్గీకరణ",
      ph: "నేల ఆమ్లత్వం (pH)",
      temp: "సగటు ఉష్ణోగ్రత (°C)",
      rain: "వార్షిక వర్షపాతం (mm)",
      state: "రాష్ట్రం",
      presets: "త్వరిత నేల ప్రీసెట్‌లు (డెమో సహాయకం)",
      presetRice: "వరి నేల ప్రొఫైల్",
      presetWheat: "గోధుమ నేల ప్రొఫైల్",
      presetCotton: "పత్తి నేల ప్రొఫైల్",
      submit: "నేల విశ్లేషణ & పంట సిఫార్సు",
      reportTitle: "AI వ్యవసాయ సలహా & పంట నివేదిక",
      placeholder: "సిఫార్సు పొందడానికి క్లిక్ చేయండి.",
    }
  }[language];
        ...
        <div className="lg:col-span-7 bg-emerald-50 border-2 border-stone-900 rounded-3xl p-6 shadow-[4px_4px_0px_0px_rgba(28,25,23,1)] flex flex-col justify-between">
          <div>
            ...
            <div className="bg-blue-50 border border-blue-300 rounded-xl p-4 mb-4 text-xs text-blue-900">
              <strong>AI Reasoning Notice</strong>
              <br />
              {labels.sub}
            </div>
