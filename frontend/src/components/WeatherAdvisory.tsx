...
export default function WeatherAdvisory({ language }: WeatherAdvisoryProps) {
  ...
  const labels = {
    ...
    te: {
      ...
      sub: "జిల్లా సూక్ష్మ వాతావరణం ఆధారంగా స్మార్ట్ స్థానిక హెచ్చరికలు మరియు 3-రోజుల వ్యవసాయ సూచనలు",
      stateLabel: "రాష్ట్రాన్ని ఎంచుకోండి",
      districtLabel: "జిల్లా/ప్రాంతాన్ని ఎంచుకోండి",
      getAdvisory: "సలహా నివేదికను రూపొందించండి",
      metricsTitle: "వ్యవసాయం కోసం వాతావరణ సూచికలు",
      temp: "ఉష్ణోగ్రత",
      humidity: "తేమ",
      wind: "గాలి వేగం",
      soilMoist: "నేల తేమ",
      pestRisk: "తెగుళ్ళ సోకు ప్రమాద సూచిక",
      advisoryReport: "AI వాతావరణ సలహా బులెటిన్",
      errorMsg: "దయచేసి ఒక ప్రాంతాన్ని ఎంచుకోండి మరియు మీ వ్యవసాయ-వాతావరణ సలహా నివేదికను రూపొందించండి.",
    }
  }[language];
